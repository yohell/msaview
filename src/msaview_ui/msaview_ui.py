...
def main(argv):
    ...
    try:
        oUI.initprog(argv=argv[1:], showusageonnoargs=False, docsfile=os.path.join(sys.path[0], "msaview_ui.docs"))
        ...
        if dsxOptions['show-settings']:
            new_preset_name = show_settings(m, dsxOptions['show-settings'])
            return 0
